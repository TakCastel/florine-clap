...
export const Film = defineDocumentType(() => ({
  ...
  fields: {
    ...
    cadres: { type: 'string', required: false },
    scenario: { type: 'string', required: false },
    assistantsMiseEnScene: { type: 'string', required: false },
    assistanteMiseEnScene: { type: 'string', required: false },
    assistanteMontage: { type: 'string', required: false },
    assistantsImages: { type: 'string', required: false },
    steadycamer: { type: 'string', required: false },
    etalonnage: { type: 'string', required: false },
    montageSon: { type: 'string', required: false },
    producteur: { type: 'string', required: false },
    producteurs: { type: 'string', required: false },
    realisateurCaptation: { type: 'string', required: false },
    imageCaptation: { type: 'string', required: false },
    // Diffusion/Sélection
