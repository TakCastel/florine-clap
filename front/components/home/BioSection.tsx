    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 w-full">
        <div className="relative">
          ...
          <div className="w-full md:w-[38%] lg:w-[35%] relative group md:float-left md:mr-10 lg:mr-12 mb-8 md:mb-6 mx-auto md:mx-0 md:mt-2">
            ...
            {isMobile ? (
              ...
              <div className="relative overflow-visible" style={{ shapeOutside: 'margin-box' }}>
                <motion.div 
                  ref={imageRef}
                  className="relative overflow-hidden"
                  initial={{ opacity: 0 }}
                ...
                >
                  <div 
                    className="relative w-full h-auto aspect-[3/4] max-h-[650px] transition-transform duration-700 ease-out bg-gray-100"
                    style={{
                      transform: `translate(${mousePosition.x * 0.1}px, ${mousePosition.y * 0.1}px)`,
                      shapeOutside: 'inset(0% 0% 0% 0% round 0px)',
                    }}
                  >
                    {bioImageUrl ? (
                      <Image 
          ...
          <div className="relative md:pt-0">
            ...
            {/* Contenu texte depuis Directus ou par défaut */}
            {homeSettings?.bio_text ? (
              <motion.div
                style={{ opacity: paragraph1Opacity }}
                className="space-y-5 text-black/85 text-base leading-relaxed [&_p]:text-justify md:pr-0"
              >
                <MarkdownRenderer content={homeSettings.bio_text} />
              </motion.div>
            ) : (
              <>
                {/* Premiers paragraphes à côté de l'image */}
                <div className="space-y-5 text-black/85 text-base leading-relaxed [&_p]:text-justify md:pr-0">
                  {/* Membres d'associations */}
                  <Reveal delay={0.5} duration={0.8} className="mb-5 pb-5 border-b border-black/10 inline-block">
                    <p className="text-xs text-black/70 uppercase tracking-wider font-medium">
                  ...
                  <motion.div
                    style={{ opacity: paragraph1Opacity }}
                  >
                    <p className="text-base leading-relaxed font-normal text-black/85">
                  ...
                  {/* Parcours cinématographique - deuxième paragraphe avec espacement ajusté */}
                  <motion.div
                ...
                <div className="clear-both space-y-5 text-black/85 text-base leading-relaxed mt-8 [&_p]:text-justify">
                  <motion.div
