...
export default function QuoteSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative py-12 md:py-20 border-b border-black/5 flex items-center justify-center min-h-[300px] bg-gradient-to-br from-white to-gray-100/50"
    ...
    >
      <div className="relative z-10 max-w-container-small mx-auto px-6 md:px-10 lg:px-16 w-full flex items-center justify-center">
        <motion.div 
          className="relative mx-auto max-w-container-small text-center space-y-6 w-full"
          style={{
            opacity,
            y,
          }}
